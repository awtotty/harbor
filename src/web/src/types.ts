...
export type UpdateStatus = { current: HarborVersion; latest?: { tag: string; url: string; commit?: string }; available: boolean; updaterConfigured: boolean; updaterUrl?: string; error?: string; message?: string };
